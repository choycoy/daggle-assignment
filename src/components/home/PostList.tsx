      ...
      {postList.map((post: Post) => {
        ...
        return (
          ...
          >
            ...
            <div className="text-gray-06 tab:leading-[24px] tab:tracking-[-0.048px] tab:text-base tab:static relative flex items-center gap-x-2 text-sm leading-[21px] tracking-[-0.042px]">
              ...
              <div className="tab:static absolute right-0 ml-auto flex items-center gap-x-2">
