      ...
      {postList.map((post: Post) => {
        ...
        return (
          ...
          >
            ...
            <div className="text-gray-06 tab:leading-[24px] tab:tracking-[-0.048px] tab:text-base tab:justify-baseline flex w-full items-center justify-between gap-x-2 text-sm leading-[21px] tracking-[-0.042px]">
